package com.example.excecise.cloudstreamkafkaplayground.sec10;
...
public class HeatIndexCalculator {
    ...
    public Function<Tuple2<Flux<Integer>, Flux<Integer>>, Flux<Long>> processor() {
        return tuple -> Flux
                .combineLatest(tuple.getT1(),tuple.getT2(), this::findHeatIndex);
    }
    ...
    private long findHeatIndex(int temperature, int humidity) {
        ...
        double index = c1 + (c2 * temperature) + (c3 * humidity)
